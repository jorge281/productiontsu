    ...
    const handleScrollFiltro = (event) => {
        ...
        if ((scrollTop + clientHeight + 2) >= scrollHeight) {
            if(consultandoTickesPrincipal == true && terminoDeCargarTickets == true){
                ...
                if(menuActivo == 1){
                    if(submenuActivo == 1){
                        cargarTicketsPendientes(usuarioId,(offsetActivo+50))
                    }
                    if(submenuActivo == 2){
                        cargarTicketsTrabajando(usuarioId,(offsetActivo+50))
                    }
                }
                else if(menuActivo == 2){
                    cargarTicketsPagos(usuarioId,(offsetActivo+50))
                }
                else if(menuActivo == 3){
                    cargarTicketsProduccion(usuarioId,(offsetActivo+50))
                }
                else if(menuActivo == 4){
                    cargarTicketsDespachados(usuarioId,(offsetActivo+50))
                }
                else if(menuActivo == 5){
                    cargarTicketsClientes(usuarioId,(offsetActivo+50))
                }
                else if(menuActivo == 6){
                    cargarTicketsNoInteresados(usuarioId,(offsetActivo+50))
                }
            }
