...
export default function Home() {
    ...
    function aprobarModal(data){
        ...
        const isImage = /\.(jpg|jpeg|png|gif)$/.test(data.ruta.toLowerCase());
                                                ...
                                                {consultando ? (
                                                    ...
                                                    comprobantes.length === 0 ? (
                                                        ...
                                                        comprobantes.map((comprobante, index) => {
                                                            const isImage = /\.(jpg|jpeg|png|gif)$/.test(comprobante.ruta.toLowerCase());
                                                            return (
                                                                <React.Fragment key={index}>
                                                                    <tr>
                                                                        ...
                                                                        <td style={{textAlign:'center'}} onClick={() => aprobarModal(comprobante)}>
                                                                            {isImage ? (
                                                                                <img
                                                                                    src={'https://www.crmtsu.com:2989/static/comprobantes/'+comprobante.ruta}
                                                                                    alt="preview"
