    ...
    useEffect(() => {
        ...
        if(cargoSite == 0){
            ...
            if(token != undefined){
                ...
                $(".navbar").hide();
                usuarioId = 19;//decodedToken.payload.user; 
        ...
        <div className="container-xxl flex-grow-1 containerP" style={{background:'#eeeeee',height: '100%',width: '100%',position: 'relative',left: '0px',top: '0px',overflow: 'hidden'}}>
            <div className='row' style={{height:'100%',width:'98%',margin:'auto'}}>
                        ...
                        <div className="card-body" style={{width:'100%',height:'93vh',overflow:'auto',paddingBottom:'50px'}}>
                            <div className="d-flex align-items-start align-items-sm-center">
                                <div className='row' >
                                    ...
                                    <div className='col-12' style={{marginTop:'10px',display:'none'}}>
                                    ...
                                    <div className='col-3' style={{display:'none',marginTop:'10px',textAlign:'center',borderRight:'2px solid #e1e1e1'}}>
                                    ...
                                    <div className='col-3' style={{display:'none',marginTop:'10px',textAlign:'center',borderRight:'2px solid #e1e1e1'}}>
                                        <h4 style={{marginBottom:'0px'}}>500</h4>
                                        <span>Asignados</span>
                                    </div>
                                    <div className='col-3' style={{display:'none',marginTop:'10px',textAlign:'center'}}>
                                        <h4 style={{marginBottom:'0px'}}>100</h4>
                                        <span>Aceptados</span>
                                    </div>
                                    <div className='col-6' style={{display:'none',fontSize:'12px',lineHeight:'25px',marginTop:'40px'}}>
                                        <div style={{display: 'flex',alignItems:'center',height:'100%'}}>
                                            <div>
                                                <span>
                                    ...
                                    <div className='col-6' style={{display:'none',marginTop:'40px'}}>
                                        <table className="table" style={{fontSize:'10px'}}>
                                            <thead>
                                                <tr>
                                                    <th scope="col" style={{textAlign:'center',background:"none"}}></th>
                                                    <th scope="col" style={{textAlign:'center',background:"#e9e9e9",fontSize:'10px'}}>PAGOS</th>
                                                    <th scope="col" style={{textAlign:'center',background:"#e9e9e9",fontSize:'10px'}}>PENDIENTES</th>
                                                    <th scope="col" style={{textAlign:'center',background:"#e9e9e9",fontSize:'10px'}}>TOTAL</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style={{textAlign:'right',background:"#e9e9e9"}}>BONOS (1)</td>
                                                    <td style={{textAlign:'center',borderRight:'2px solid #e9e9e9'}}>
                                                        $50.000
                                                    </td>
                                                    <td style={{textAlign:'center',borderRight:'2px solid #e9e9e9'}}>$0</td>
                                                    <td style={{textAlign:'center',borderRight:'2px solid #e9e9e9'}}>$50.000</td>
                                                </tr>
                                                <tr>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td style={{ textAlign: 'center',borderLeft:'2px solid #e9e9e9'}}>$50.000</td>
                                                    <td style={{ textAlign: 'center',borderLeft:'2px solid #e9e9e9'}}>$50.000</td>
                                                    <td style={{ textAlign: 'center',borderLeft:'2px solid #e9e9e9',borderRight:'2px solid #e9e9e9'}}>$100.000</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                ...
                <div className='col-3' style={{maxHeight:'100vh',overflow:'auto',background:'#f5f5f5',paddingTop:'40px',paddingBottom:'40px',boxShadow:'0px 0px 18px 0px #bdbdbdbf'}}>
                    ...
                    <label style={{marginTop:'20px',background:'#e9e9e9',width:'94%',padding:'10px',textAlign:'center',marginLeft:'3%'}}>CARTERA</label>
                    <div className='row' style={{width:'94%',border:'2px solid #e9e9e9',padding:'10px 0px',marginLeft:'3%',fontSize:'12px'}}>
                        <div className='col-6' style={{paddingRight:'0px'}}>
                        ...
                        <div className='col-4' style={{textAlign:'right',paddingLeft:'0px'}}>
                            {dataResumen.resumenCartera.map((result, index) => (
                                <>  
                                    {result.mesActual == 1 && (
                                        <>  
                                            <span style={{color:'red'}}>{formattedPrice(result.valor)}</span>
                                            <br></br>
                                        </>
                                    )}
                                </>
                        ...
                        {dataResumen.carteraMesAnterior && (
                            <>
                            <div className='col-12' style={{textAlign:'center',background:'#e1e1e1',margin:'auto',width:'90%',marginTop:'10px',marginBottom:'10px'}}>
                                MESES ANTERIORES
                            </div>
                            </>
                        )}
