        ...
        if ((scrollTop + clientHeight + 2) >= scrollHeight) {
            if(bandera == 1){
                if(consultando1 == false){
                    consultando1 = true;
                    if(menuSeleccionado1 == 1){
                        cargarTicketsTrabajando(usuario.user,(offsetActivo+10))
                    }else{
                        cargarTicketsPendientes(usuario.user,(offsetActivo+10))
                    }
                }
            }
            if(bandera == 2){
                if(consultando1 == false){
                    consultando1 = true;
                    cargarTicketsPagos(usuario.user,(offsetActivo+10))
                }
            }
            if(bandera == 6){
                if(consultando1 == false){
                    consultando1 = true;
                    cargarTicketsNoInteresados(usuario.user,(offsetActivo+10))
                }
            }
        }
    }

    function cargasmasMessages(){
        if(tieneMensajesPendientes == true){
            cargarMessagesTicket(ticketAbierto2.id,(offsetMessagesActivos+20))
            setTimeout(() => {
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-8" style={{padding:'0px',border: '1px solid #b7b7b7',height: 'calc(100vh - 202px)',maxHeight: 'calc(100vh - 202px)',marginTop: '10px'}}>
                                    ...
                                    <div style={divStyle}>
                                        <button onClick={cargasmasMessages}>cargar messages</button>
